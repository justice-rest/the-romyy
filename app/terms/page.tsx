    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 md:py-24">
        ...
        <div className="prose dark:prose-invert mt-20 w-full min-w-full">
          ...
          <ul>
            <li>Access to multiple AI language models from various providers (OpenAI, Anthropic, Google, Mistral, Perplexity, XAI, OpenRouter, and Ollama)</li>
            <li>Bring Your Own Key (BYOK) functionality allowing users to use their own API keys</li>
          ...
          <p>
            Users may provide their own API keys for third-party AI service providers. When you provide API keys:
          </p>
          <ul>
            <li>You retain full ownership and control of your API keys</li>
            <li>We encrypt your keys using industry-standard encryption (AES-256)</li>
            <li>You are solely responsible for any costs incurred with third-party providers</li>
            <li>You must comply with the terms of service of each third-party provider</li>
          </ul>

          <h3>4.2 Key Security</h3>
          <p>
            While we implement encryption and security measures to protect your API keys, you acknowledge that no system is completely secure. You use BYOK functionality at your own risk.
          </p>

          <h2>5. Usage Limits and Rate Limiting</h2>
          <p>
          ...
          <ul>
            ...
            <li>Violate the terms of service of any third-party AI provider</li>
          </ul>

          <h3>6.2 Content Restrictions</h3>
          <p>
            When using AI models through our Service, you must comply with each provider's acceptable use policies. We reserve the right to refuse service or terminate accounts that violate these policies.
          </p>
          ...
          <p>
            Your content may be processed by third-party AI providers based on the models you select. When using BYOK, data is sent directly to the respective provider under their terms of service.
          </p>
          ...
          <h3>7.4 AI-Generated Content</h3>
          <p>
            Content generated by AI models through the Service is provided as-is. You are responsible for reviewing and verifying all AI-generated content before use. We make no warranties regarding accuracy, completeness, or reliability of AI outputs.
          </p>
          ...
          <ul>
            <li>AI model providers (OpenAI, Anthropic, Google, Mistral, Perplexity, XAI, OpenRouter)</li>
          ...
          <ul>
            ...
            <li>Costs incurred from using BYOK with third-party providers</li>
          </ul>
          <p>
          ...
          <h3>11.4 AI Model Disclaimer</h3>
          <p>
            AI models may produce inaccurate, biased, or inappropriate content. You use AI-generated content at your own risk and should verify information independently before relying on it.
          </p>
          ...
          <ul>
            ...
            <li>Your use of BYOK and third-party API keys</li>
          </ul>
