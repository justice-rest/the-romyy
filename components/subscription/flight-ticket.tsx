    ...
    <>
      ...
      <div className="ticket-box">
        ...
        <div className="ticket">
          <span className="airline">Rōmy</span>
          <span className="airline airlineslip">Rōmy</span>
          <span className="boarding">Credit Pass</span>
          <div className="content">
            <span className="jfk">WE</span>
            ...
            <span className="sfo">YOU</span>

            <span className="jfk jfkslip">WE</span>
            ...
            <span className="sfo sfoslip">YOU</span>
            <div className="sub-content">
              <span className="watermark">Get Rōmy</span>
              <span className="name">
                PASSENGER NAME
                <br />
